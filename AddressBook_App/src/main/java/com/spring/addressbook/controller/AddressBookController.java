...
public class AddressBookController 
{
	...
	public ResponseEntity<ResponseDTO> addRecord(@RequestBody AddressBookDTO addressbookdto)
	{
	...
	public ResponseEntity<ResponseDTO> ModifyRecord(@RequestBody AddressBookDTO addressbookdto,@PathVariable int id)
	{
